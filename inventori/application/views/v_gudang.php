  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="content-row">
        <h2 class="content-row-title">Data gudang</h2>

        <div class="row" style="margin-bottom: 10px">

          <div class="card">
            <div class="col-md-4">
              <?php echo anchor(site_url('gudang/create'), 'Tambah', 'class="btn btn-primary"'); ?>
            ...
            <div class="col-md-4 text-right">
              <?php if ($this->session->userdata('level') == 'manajer') { ?>
                <a class="btn btn-danger" href="gudang1"> <i class="glyphicon glyphicon-trash"></i> </a>
              <?php } ?>
            </div>
          </div>
          </br>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center" width="200px">
                      ...
                      echo anchor(site_url('gudang/update/' . $user->id_user), 'Ubah', 'class="btn btn-info btn-sm"');
                      echo '  ';
                      echo anchor(site_url('gudang/delete/' . $user->id_user), 'Hapus', 'class="btn btn-danger btn-sm", onclick="javasciprt: return confirm(\'Apa Anda Yakin?\')"');
                      ?>
                    </td>
                  </tr>
                <?php
