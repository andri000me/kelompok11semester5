...
<div class="col-xs-12 col-sm-9 content">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a>Data komplain</h3>
    </div>
    <div class="panel-body">
      <div class="content-row">
        <h2 class="content-row-title">Data Komplain</h2>
        <div class="row">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $komplain->tgl_komplain ?></td>
                    <td><?php echo $komplain->id_keluar ?></td>
                    <td><?php echo $komplain->nama ?></td>
                    <td><?php echo $komplain->isi_komplain ?></td>
