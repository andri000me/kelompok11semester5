<?php
class Pelanggan1 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->m_pelanggan1->total_rows();
        $user1 = $this->m_pelanggan1->get_limit_data();
        $this->load->library('pagination');
        ...
        $this->load->view('v_pelanggan2', $data);
    }
