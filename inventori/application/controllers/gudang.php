...
?>
        ...
        ?>
            <script type="text/javascript">
                alert('Data Berhasil di Tambahkan');
                window.location = '<?php echo base_url('gudang'); ?>'
            </script>
        <?php
    ...
    public function update($id)
    {
        ...
        $this->load->view('v_header');
        $this->load->view('v_sidebar');
        $row = $this->m_gudang->get_by_id($id);
    ...
    public function update_action()
    {
        ...
        if (empty($_FILES["foto"]["name"])) {
            ...
            $this->m_gudang->update($this->input->post('id_user', TRUE), $data);
        ?>
            <script type="text/javascript">
...
<?php
    ...
    public function cetak_pdf()
    {
        ...
        $pdf->Cell(0, 7, 'DATA GUDANG', 0, 1, 'C');
        $pdf->Cell(10, 7, '', 0, 1);
        ...
        $barang = $this->db->query("SELECT * FROM user WHERE level='gudang' and del='0'")->result();
        $no = 1;
