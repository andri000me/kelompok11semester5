...
class Keluardel1 extends CI_Controller
{
	...
	public function index()
	{
		...
		$config['total_rows'] = $this->m_keluardel1->total_rows();
		$keluardel = $this->m_keluardel1->get_limit_data();
		...
		$this->load->view('v_keluardel1', $data);
	}
