...
class Keluar2 extends CI_Controller
{
	...
	public function index()
	{
		...
		$config['total_rows'] = $this->m_keluar2->total_rows();
		$keluar = $this->m_keluar2->get_limit_data();
