...
class M_cicildel1 extends CI_Model
{
    ...
    public function total_rows()
    {
        if ($this->session->userdata('level') == 'admin' or $this->session->userdata('level') == 'manajer') {
            ...
            $where = "(detail_keluar.status='0' and keluar.status='1' and cicil.del='1' and cicil.status='1') or (detail_keluar.status='1' and cicil.del='1' and keluar.status='1' and cicil.status='1')";
            $this->db->where($where);
